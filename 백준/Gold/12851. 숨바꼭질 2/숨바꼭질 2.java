...
public class Main {
	...
	public static void bfs() {
		...
		while (!queue.isEmpty()) {
			...
			// x*2
			if (cur.idx > 0 && cur.idx * 2 < 150000 && visit[cur.idx * 2] >= cur.time + 1) {
				visit[cur.idx * 2] = cur.time + 1;
				queue.offer(new Subin(cur.idx * 2, cur.time + 1));
			}
